...
var GracefulImage = /** @class */ (function (_super) {
    ...
    */
    GracefulImage.prototype.render = function () {
        ...
        return (React.createElement("img", { src: src, srcSet: this.props.srcSet, className: this.props.className, width: this.props.width, height: this.props.height, style: __assign({}, style, this.props.style), alt: this.props.alt, ref: function (ref) { return (_this.placeholderImage = ref); } }));
    };
    /*
